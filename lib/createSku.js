...
module.exports = async (opts = {}) => {
  try {
    const { host, privateKey, contractAddress, data, submitPrivateKey, submitAddress, params } = opts
    ...
    for (let item of data) {
      ...
      const inputObj = {
        ...
        params: {
          ...
          // redemptionAddress: 'buQeh7xi5hqX3LxNo1zx9CvcELVo1GuuLjF9',
